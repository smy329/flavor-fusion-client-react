    ...
    <div className="relative">
      <Pdf targetRef={ref} filename="document.pdf">
        {({ toPdf }) => (
          <>
            <button
              onClick={toPdf}
              className="theme-btn absolute top-5 right-0"
            >
              Generate PDF
            </button>
          </>
      ...
      <div className="text-lg" ref={ref}>
        <div className="flex items-center justify-between mb-10">
          <h1 className="text-center text-5xl font-bold">Printable Blogs</h1>
        </div>
        <div className="border-4 border-gray-300 rounded-lg p-3 mb-8 ">
          ...
          <ul className=" list-disc list-inside p-5">
            <li>
              ...
              of the input is stored in the DOM instead of in React's state.
              When the user interacts with the input, the input updates its own
              value in the DOM, and the React component can read that value
              using a ref.
            </li>
            <li>
              Controlled components, on the other hand, are inputs that are
              fully controlled by React. This means that the value of the input
              is stored in React's state, and the component's render method
              provides the current value to the input as a prop. When the user
              interacts with the input, an event handler updates the state,
              which causes the component to re-render with the new value.
            </li>
          </ul>
        </div>
        <div className="border-4 border-gray-300 rounded-lg p-3 mb-8 ">
          ...
          <p>
            PropTypes is a built-in library in React that allows us to declare
            the types of the props that your components expect to receive. This
            helps us to catch bugs and errors earlier, and makes your code more
        ...
        <div className="border-4 border-gray-300 rounded-lg p-3 mb-8 ">
          ...
          <p>
            ...
            more of the built-in React hooks (useState, useEffect, useContext,
            etc.) to encapsulate and reuse some behavior or stateful logic
            across multiple components. Custom hooks are a way to share
            functionality between components without having to resort to
            higher-order components or render props. Custom hooks can be created
            ...
            <ul className="list-disc list-inside p-3">
              ...
              <li>
                Abstraction: Custom hooks can abstract away implementation
                details and expose a simpler, higher-level API for other
                components to use.
              </li>
            </ul>
          </p>
